   ...
   while( true )  // a Car must loop through the following actions forever
    {
     try
        {
         ...
         System.out.println( direction + " car " + car_identification +
         ...
         if( northbound )
           controller.northbound_departure( car_identification );
         else
             controller.southbound_departure( car_identification );
     ...
     // catch any exceptions
         ...
         { System.err.println( "Car.run() Error: " + e ) ; }
